...
// this file holds all of our API routes
...
// we also need app and express but we will pass those into our routes
// since we want to use the same app as in server.js
module.exports = function (app, express) {
    // get an instance of the express router
    var apiRouter = express.Router();

// route for authenticating users (accessed at POST http://localhost:8080/api/authenticate)
...
// -----------------------------------------------------
    ...
    return apiRouter; // so that we can use it in server.js
};
